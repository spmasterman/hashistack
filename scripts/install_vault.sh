...
echo "Installing Vault as system.d service"

SYSTEMD_DIR="/lib/systemd/system"

sudo cp /vagrant/scripts/vault.service ${SYSTEMD_DIR}/
sudo cp /vagrant/scripts/consul-online.service ${SYSTEMD_DIR}/
sudo cp /vagrant/scripts/consul-online.target ${SYSTEMD_DIR}/
sudo cp /vagrant/scripts/consul-online.sh ${SYSTEMD_DIR}/
